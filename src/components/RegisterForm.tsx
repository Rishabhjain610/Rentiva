    ...
    <div className="flex items-center justify-center min-h-screen bg-linear-to-br from-green-50 via-white to-green-100 relative">
      ...
      >
        <div className="flex flex-col items-center mb-2">
          ...
          <h2 className="text-3xl font-bold text-center text-green-600 tracking-tight">Create Account</h2>
        </div>
        <button
          type="button"
        ...
        <div className="relative">
          <User className="absolute left-3 top-1/2 -translate-y-1/2 text-green-400" size={18} />
          <input
            type="text"
            placeholder="Name"
            value={name}
